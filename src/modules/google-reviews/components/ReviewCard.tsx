...
import { formatReviewDate, truncateAtWord } from '../utils';
import { StarRating } from './StarRating';

/**
 * Default avatar placeholder
 * Override via defaultAvatar prop
 */
const DEFAULT_AVATAR = '/images/default-avatar.png';

/**
 * Google icon path - place google_g_icon.svg in your public folder
 * or update this path
 */
const GOOGLE_ICON = '/google_g_icon.svg';

/**
 * Review Card Component
 * Displays a single review with author info, rating, and text
 */
